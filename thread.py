...
#                     wsc.print_xml_response()
                    ...
                    createHeader = requests.post('%s/crm-ws/create' % (ad_url.strip('/')), data={
                        ...
                        'fields':'''[{
                                        ...
                                        normalize(data['Alias_Code'] or '0'),
                                        normalize(data['Apply_Add_Trim_Flag'] and 'Y' or 'N'),
                                        normalize(data['Archive_Flag'] and 'Y' or 'N'),
                                        normalize(data['Auto_TDS'] or '1970-01-01 00:00:00'),
                                        normalize(data['BCP_Load_ID'] or '0'),
                                        normalize(data['BCP_Load_Sort'] or '0'),
                                        normalize(data['Calc_Ack_Counter'] or '0'),
                                        normalize(data['Calc_Req_Counter'] or '0'),
                                        normalize(data['Charge_Rate_Percent'] or '0'),
                                        normalize(data['Control_Sys_Code'] or '0'),
                                        normalize(data['Control_SysID'] or '0'),
                                        normalize(data['CreateDate'] or '1970-01-01 00:00:00'),
                                        normalize(data['CreatedBy'] or '0'),
                                        normalize(data['DemandID'] or '0'),
                                        normalize(data['Design_Slump'] or '0'),
                                        normalize(data['Ended_Load_Status'] or '0'),
                                        normalize(data['Failed_Flag'] and 'Y' or 'N'),
                                        normalize(data['Load_Code'] or '0'),
                                        normalize(data['Load_Discharge_TDS'] or '1970-01-01 00:00:00'),
                                        normalize(data['Load_End_TDS'] or '1970-01-01 00:00:00'),
                                        normalize(data['Load_Size'] or '0'),
                                        normalize(data['Load_Sort_Num'] or '0'),
                                        normalize(data['Load_Start_TDS'] or '1970-01-01 00:00:00'),
                                        normalize(data['LoadID'] or '0'),
                                        normalize(data['LoadStarted_UserCode'] or '0'),
                                        normalize(data['Manual_Feed_Flag'] and 'Y' or 'N'),
                                        normalize(data['Manual_TDS'] or '1970-01-01 00:00:00'),
                                        normalize(data['Max_Batch'] or '0'),
                                        normalize(data['Max_Batch_Size'] or '0'),
                                        normalize(data['Max_Batch_Size_UOM'] or '0'),
                                        normalize(data['Max_Dispatch_WCR'] or '0'),
                                        normalize(data['Mix_Entry_Ref_Type'] or '0'),
                                        normalize(data['Mixer_TS'] or '0'),
                                        normalize(data['NoteExistsFlag'] and 'Y' or 'N'),
                                        normalize(data['Notify_UserCode'] or '0'),
                                        normalize(data['RecordDate'] or '1970-01-01 00:00:00'),
                                        normalize(data['ReferenceLoadID'] or '0'),
                                        normalize(data['Reship_Batched_TDS'] or '1970-01-01 00:00:00'),
                                        normalize(data['Reship_Incompatible_Flag'] and 'Y' or 'N'),
                                        normalize(data['Reship_Item_Code'] or '0'),
                                        normalize(data['Reship_Item_Description'] or '0'),
                                        normalize(data['Reship_ItemID'] or '0'),
                                        normalize(data['Reship_Load_Code'] or '0'),
                                        normalize(data['Reship_LoadID'] or '0'),
                                        normalize(data['Reship_Qty'] or '0'),
                                        normalize(data['Reship_Qty_UOM'] or '0'),
                                        normalize(data['Reship_Source_Type'] or '0'),
                                        normalize(data['RowPointer'] or '0'),
                                        normalize(data['Run_Ack_Counter'] or '0'),
                                        normalize(data['Run_Req_Counter'] or '0'),
                                        normalize(data['Sequence_Code'] or '0'),
                                        normalize(data['SequenceID'] or '0'),
                                        normalize(data['Sequencing_Flag'] and 'Y' or 'N'),
                                        normalize(data['Simulate_Status'] or '0'),
                                        normalize(data['Slump'] or '0'),
                                        normalize(data['Slump_Code'] or '0'),
                                        normalize(data['Slump_UOM'] or '0'),
                                        normalize(data['SlumpID'] or '0'),
                                        normalize(data['Started_Load_Status'] or '0'),
                                        normalize(data['UpdatedBy'] or '0'),
                                        normalize(data['Washout_Used_Flag'] and 'Y' or 'N'),
                                        normalize(data['Water_Cement_Ratio'] or '0'),
                                        normalize(data['Water_In_Truck'] or '0'),
                                        normalize(data['Water_In_Truck_UOM'] or '0'),
                                        normalize(data['Item_Code'] or '0'),
                                        normalize(data['Ticket_Code'] or '0'),
                                        m_warehouse_id,
                                        combatchmachine,
                                        'N'
                                    ),
...
#                         proc_line.save()
                    ...
                    createLine = requests.post('%s/crm-ws/create' % (ad_url.strip('/')), data={
                        ...
                        'fields':'''[{
                                        ...
                                        normalize(data["Absorbed_Water"] or '0'),
                                        normalize(data["Absorption_Percent"] or '0'),
                                        normalize(data["Actual_Water"] or '0'),
                                        normalize(data["Actual_Water_Calc_Type"] or '0'),
                                        normalize(data["Adjust_UOM"] or '0'),
                                        normalize(data["Alias_Code"] or '0'),
                                        normalize(data["Amt_UOM"] or '0'),
                                        normalize(data["Archive_Flag"] and "Y" or "N"),
                                        normalize(data["Based_On_Factor"] or '0'),
                                        normalize(data["Based_On_Qty"] or '0'),
                                        normalize(data["Based_On_UOM"] or '0'),
                                        normalize(data["Calc_Factor"] or '0'),
                                        normalize(data["Calc_Moisture_Percent"] or '0'),
                                        normalize(data["Correction_Factor"] or '0'),
                                        normalize(data["CreateDate"] or '1970-01-01 00:00:00'),
                                        normalize(data["CreatedBy"] or '0'),
                                        normalize(data["Delete_Flag"] and "Y" or "N"),
                                        normalize(data["Design_Absorbed_Water"] or '0'),
                                        normalize(data["Design_Entry_Qty"] or '0'),
                                        normalize(data["Design_Free_Water"] or '0'),
                                        normalize(data["Design_SSD_Net_Target_Qty"] or '0'),
                                        normalize(data["Design_SSD_Qty"] or '0'),
                                        normalize(data["Design_UOM"] or '0'),
                                        normalize(data["Dispatch_Design_Qty"] or '0'),
                                        normalize(data["Dispatch_Design_UOM"] or '0'),
                                        normalize(data["Do_Not_Batch_Flag"] and "Y" or "N"),
                                        normalize(data["Effectiveness_Percent"] or '0'),
                                        normalize(data["Ingred_ItemID"] or '0'),
                                        normalize(data["Ingredient_Source_Type"] or '0'),
                                        normalize(data["Item_Code"] or '0'),
                                        normalize(data["Item_Description"] or '0'),
                                        normalize(data["Kgs_Per_Liter"] or '0'),
                                        normalize(data["Load_Adjust_Qty"] or '0'),
                                        normalize(data["Load_LineID"] or '0'),
                                        normalize(data["LoadID"] or '0'),
                                        normalize(data["Manual_Feed_Flag"] and "Y" or "N"),
                                        normalize(data["Modified_Flag"] and "Y" or "N"),
                                        normalize(data["Moisture_Entry_Ref_Type"] or '0'),
                                        normalize(data["Net_Auto_Batched_Amt"] or '0'),
                                        normalize(data["Net_Batched_Amt"] or '0'),
                                        normalize(data["Net_Target_Amt"] or '0'),
                                        normalize(data["Net_Used_Amt"] or '0'),
                                        normalize(data["NoteExistsFlag"] and "Y" or "N"),
                                        normalize(data["RecordDate"] or '1970-01-01 00:00:00'),
                                        normalize(data["RowPointer"] or '0'),
                                        normalize(data["Scale_UOM"] or '0'),
                                        normalize(data["Slump_Factor"] or '0'),
                                        normalize(data["Solids_Specific_Gravity"] or '0'),
                                        normalize(data["Sort_Line_Num"] or '0'),
                                        normalize(data["Specific_Gravity"] or '0'),
                                        normalize(data["Substitution_Factor"] or '0'),
                                        normalize(data["Tolerance_Over_Amt"] or '0'),
                                        normalize(data["Tolerance_Under_Amt"] or '0'),
                                        normalize(data["Total_Moisture_Percent"] or '0'),
                                        normalize(data["Trim_Qty"] or '0'),
                                        normalize(data["Trim_UOM"] or '0'),
                                        normalize(data["UpdatedBy"] or '0'),
                                        normalize(data["Water_UOM"] or '0'),
                                        "N"
                                    ),
