...
#                     wsc.print_xml_response()
                    ...
                    createHeader = requests.post('%s/crm-ws/create' % (ad_url.strip('/')), data={
                        ...
                        'fields':'''[{
                                        ...
                                        (data['Alias_Code'] or '0').replace('\'','\\\''),
                                        (data['Apply_Add_Trim_Flag'] and 'Y' or 'N').replace('\'','\\\''),
                                        (data['Archive_Flag'] and 'Y' or 'N').replace('\'','\\\''),
                                        (data['Auto_TDS'] or '1970-01-01 00:00:00').replace('\'','\\\''),
                                        (data['BCP_Load_ID'] or '0').replace('\'','\\\''),
                                        (data['BCP_Load_Sort'] or '0').replace('\'','\\\''),
                                        (data['Calc_Ack_Counter'] or '0').replace('\'','\\\''),
                                        (data['Calc_Req_Counter'] or '0').replace('\'','\\\''),
                                        (data['Charge_Rate_Percent'] or '0').replace('\'','\\\''),
                                        (data['Control_Sys_Code'] or '0').replace('\'','\\\''),
                                        (data['Control_SysID'] or '0').replace('\'','\\\''),
                                        (data['CreateDate'] or '1970-01-01 00:00:00').replace('\'','\\\''),
                                        (data['CreatedBy'] or '0').replace('\'','\\\''),
                                        (data['DemandID'] or '0').replace('\'','\\\''),
                                        (data['Design_Slump'] or '0').replace('\'','\\\''),
                                        (data['Ended_Load_Status'] or '0').replace('\'','\\\''),
                                        (data['Failed_Flag'] and 'Y' or 'N').replace('\'','\\\''),
                                        (data['Load_Code'] or '0').replace('\'','\\\''),
                                        (data['Load_Discharge_TDS'] or '1970-01-01 00:00:00').replace('\'','\\\''),
                                        (data['Load_End_TDS'] or '1970-01-01 00:00:00').replace('\'','\\\''),
                                        (data['Load_Size'] or '0').replace('\'','\\\''),
                                        (data['Load_Sort_Num'] or '0').replace('\'','\\\''),
                                        (data['Load_Start_TDS'] or '1970-01-01 00:00:00').replace('\'','\\\''),
                                        (data['LoadID'] or '0').replace('\'','\\\''),
                                        (data['LoadStarted_UserCode'] or '0').replace('\'','\\\''),
                                        (data['Manual_Feed_Flag'] and 'Y' or 'N').replace('\'','\\\''),
                                        (data['Manual_TDS'] or '1970-01-01 00:00:00').replace('\'','\\\''),
                                        (data['Max_Batch'] or '0').replace('\'','\\\''),
                                        (data['Max_Batch_Size'] or '0').replace('\'','\\\''),
                                        (data['Max_Batch_Size_UOM'] or '0').replace('\'','\\\''),
                                        (data['Max_Dispatch_WCR'] or '0').replace('\'','\\\''),
                                        (data['Mix_Entry_Ref_Type'] or '0').replace('\'','\\\''),
                                        (data['Mixer_TS'] or '0').replace('\'','\\\''),
                                        (data['NoteExistsFlag'] and 'Y' or 'N').replace('\'','\\\''),
                                        (data['Notify_UserCode'] or '0').replace('\'','\\\''),
                                        (data['RecordDate'] or '1970-01-01 00:00:00').replace('\'','\\\''),
                                        (data['ReferenceLoadID'] or '0').replace('\'','\\\''),
                                        (data['Reship_Batched_TDS'] or '1970-01-01 00:00:00').replace('\'','\\\''),
                                        (data['Reship_Incompatible_Flag'] and 'Y' or 'N').replace('\'','\\\''),
                                        (data['Reship_Item_Code'] or '0').replace('\'','\\\''),
                                        (data['Reship_Item_Description'] or '0').replace('\'','\\\''),
                                        (data['Reship_ItemID'] or '0').replace('\'','\\\''),
                                        (data['Reship_Load_Code'] or '0').replace('\'','\\\''),
                                        (data['Reship_LoadID'] or '0').replace('\'','\\\''),
                                        (data['Reship_Qty'] or '0').replace('\'','\\\''),
                                        (data['Reship_Qty_UOM'] or '0').replace('\'','\\\''),
                                        (data['Reship_Source_Type'] or '0').replace('\'','\\\''),
                                        (data['RowPointer'] or '0').replace('\'','\\\''),
                                        (data['Run_Ack_Counter'] or '0').replace('\'','\\\''),
                                        (data['Run_Req_Counter'] or '0').replace('\'','\\\''),
                                        (data['Sequence_Code'] or '0').replace('\'','\\\''),
                                        (data['SequenceID'] or '0').replace('\'','\\\''),
                                        (data['Sequencing_Flag'] and 'Y' or 'N').replace('\'','\\\''),
                                        (data['Simulate_Status'] or '0').replace('\'','\\\''),
                                        (data['Slump'] or '0').replace('\'','\\\''),
                                        (data['Slump_Code'] or '0').replace('\'','\\\''),
                                        (data['Slump_UOM'] or '0').replace('\'','\\\''),
                                        (data['SlumpID'] or '0').replace('\'','\\\''),
                                        (data['Started_Load_Status'] or '0').replace('\'','\\\''),
                                        (data['UpdatedBy'] or '0').replace('\'','\\\''),
                                        (data['Washout_Used_Flag'] and 'Y' or 'N').replace('\'','\\\''),
                                        (data['Water_Cement_Ratio'] or '0').replace('\'','\\\''),
                                        (data['Water_In_Truck'] or '0').replace('\'','\\\''),
                                        (data['Water_In_Truck_UOM'] or '0').replace('\'','\\\''),
                                        (data['Item_Code'] or '0').replace('\'','\\\''),
                                        (data['Ticket_Code'] or '0').replace('\'','\\\''),
                                        m_warehouse_id,
                                        combatchmachine,
                                        'N'
                                    ),
...
#                         proc_line.save()
                    ...
                    createLine = requests.post('%s/crm-ws/create' % (ad_url.strip('/')), data={
                        ...
                        'fields':'''[{
                                        ...
                                        (data["Absorbed_Water"] or '0').replace('\'','\\\''),
                                        (data["Absorption_Percent"] or '0').replace('\'','\\\''),
                                        (data["Actual_Water"] or '0').replace('\'','\\\''),
                                        (data["Actual_Water_Calc_Type"] or '0').replace('\'','\\\''),
                                        (data["Adjust_UOM"] or '0').replace('\'','\\\''),
                                        (data["Alias_Code"] or '0').replace('\'','\\\''),
                                        (data["Amt_UOM"] or '0').replace('\'','\\\''),
                                        (data["Archive_Flag"] and "Y" or "N").replace('\'','\\\''),
                                        (data["Based_On_Factor"] or '0').replace('\'','\\\''),
                                        (data["Based_On_Qty"] or '0').replace('\'','\\\''),
                                        (data["Based_On_UOM"] or '0').replace('\'','\\\''),
                                        (data["Calc_Factor"] or '0').replace('\'','\\\''),
                                        (data["Calc_Moisture_Percent"] or '0').replace('\'','\\\''),
                                        (data["Correction_Factor"] or '0').replace('\'','\\\''),
                                        (data["CreateDate"] or '1970-01-01 00:00:00').replace('\'','\\\''),
                                        (data["CreatedBy"] or '0').replace('\'','\\\''),
                                        (data["Delete_Flag"] and "Y" or "N").replace('\'','\\\''),
                                        (data["Design_Absorbed_Water"] or '0').replace('\'','\\\''),
                                        (data["Design_Entry_Qty"] or '0').replace('\'','\\\''),
                                        (data["Design_Free_Water"] or '0').replace('\'','\\\''),
                                        (data["Design_SSD_Net_Target_Qty"] or '0').replace('\'','\\\''),
                                        (data["Design_SSD_Qty"] or '0').replace('\'','\\\''),
                                        (data["Design_UOM"] or '0').replace('\'','\\\''),
                                        (data["Dispatch_Design_Qty"] or '0').replace('\'','\\\''),
                                        (data["Dispatch_Design_UOM"] or '0').replace('\'','\\\''),
                                        (data["Do_Not_Batch_Flag"] and "Y" or "N").replace('\'','\\\''),
                                        (data["Effectiveness_Percent"] or '0').replace('\'','\\\''),
                                        (data["Ingred_ItemID"] or '0').replace('\'','\\\''),
                                        (data["Ingredient_Source_Type"] or '0').replace('\'','\\\''),
                                        (data["Item_Code"] or '0').replace('\'','\\\''),
                                        (data["Item_Description"] or '0').replace('\'','\\\''),
                                        (data["Kgs_Per_Liter"] or '0').replace('\'','\\\''),
                                        (data["Load_Adjust_Qty"] or '0').replace('\'','\\\''),
                                        (data["Load_LineID"] or '0').replace('\'','\\\''),
                                        (data["LoadID"] or '0').replace('\'','\\\''),
                                        (data["Manual_Feed_Flag"] and "Y" or "N").replace('\'','\\\''),
                                        (data["Modified_Flag"] and "Y" or "N").replace('\'','\\\''),
                                        (data["Moisture_Entry_Ref_Type"] or '0').replace('\'','\\\''),
                                        (data["Net_Auto_Batched_Amt"] or '0').replace('\'','\\\''),
                                        (data["Net_Batched_Amt"] or '0').replace('\'','\\\''),
                                        (data["Net_Target_Amt"] or '0').replace('\'','\\\''),
                                        (data["Net_Used_Amt"] or '0').replace('\'','\\\''),
                                        (data["NoteExistsFlag"] and "Y" or "N").replace('\'','\\\''),
                                        (data["RecordDate"] or '1970-01-01 00:00:00').replace('\'','\\\''),
                                        (data["RowPointer"] or '0').replace('\'','\\\''),
                                        (data["Scale_UOM"] or '0').replace('\'','\\\''),
                                        (data["Slump_Factor"] or '0').replace('\'','\\\''),
                                        (data["Solids_Specific_Gravity"] or '0').replace('\'','\\\''),
                                        (data["Sort_Line_Num"] or '0').replace('\'','\\\''),
                                        (data["Specific_Gravity"] or '0').replace('\'','\\\''),
                                        (data["Substitution_Factor"] or '0').replace('\'','\\\''),
                                        (data["Tolerance_Over_Amt"] or '0').replace('\'','\\\''),
                                        (data["Tolerance_Under_Amt"] or '0').replace('\'','\\\''),
                                        (data["Total_Moisture_Percent"] or '0').replace('\'','\\\''),
                                        (data["Trim_Qty"] or '0').replace('\'','\\\''),
                                        (data["Trim_UOM"] or '0').replace('\'','\\\''),
                                        (data["UpdatedBy"] or '0').replace('\'','\\\''),
                                        (data["Water_UOM"] or '0').replace('\'','\\\''),
                                        "N"
                                    ),
